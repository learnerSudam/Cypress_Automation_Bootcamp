...
const menuItems = [
  {
    ...
    dataCy: "Projects_options",
  },
  {
    text: "Issues",
    iconSrc: "/icons/issues.svg",
    href: Routes.issues,
    dataCy: "Issues_options",
  },
  {
    text: "Alerts",
    iconSrc: "/icons/alert.svg",
    href: Routes.alerts,
    dataCy: "Alerts_options",
  },
  {
    text: "Users",
    iconSrc: "/icons/users.svg",
    href: Routes.users,
    dataCy: "Users_options",
  },
  {
    text: "Settings",
    iconSrc: "/icons/settings.svg",
    href: Routes.settings,
    dataCy: "Settings_options",
  },
];
      ...
      <FixedContainer>
        <Header>
          ...
          <MenuButton onClick={() => setMobileMenuOpen(!isMobileMenuOpen)}>
            <MenuIcon
              data-cy="iconsMenu_dashboardPage"
